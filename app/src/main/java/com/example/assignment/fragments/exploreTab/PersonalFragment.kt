...
import com.example.assignment.databinding.FragmentPersonalBinding
...
class PersonalFragment : Fragment() {
    ...
    lateinit var adapter:PersonalRvAdaptor
    ...
    override fun onCreateView(
       ...
       binding.rvData.layoutManager = LinearLayoutManager(context)
        adapter = PersonalRvAdaptor(requireContext(),data_list)
